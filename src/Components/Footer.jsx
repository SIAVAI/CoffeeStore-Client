...
const Footer = () => {
  return (
    ...
    >
      <div>
        <img src={logo} className="w-[20%]" alt="coffee" />
        <h2 className="text-3xl md:text-4xl lg:text-5xl text-[#331A15] font-rancho">
          Espresso Emporium
        </h2>
        <p>
        ...
        <div className="grid grid-flow-col gap-4">
          <a>
            <svg
              ...
              height="24"
              viewBox="0 0 24 24"
              className="fill-current text-[#331A15]"
            >
      ...
      <div>
        <h2 className="text-3xl text-[#331A15] font-medium font-rancho">
          Connect With Us
        </h2>
        <form className="font-raleway">
          ...
          <div className="form-control mt-4">
            <textarea
              ...
              name="message"
              className="textarea border-[#D2B48C]"
            />
          </div>
